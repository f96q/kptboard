...
type ActionCableAction =
  ...
  | { type: 'ACTION_CABLE_DROP_LABEL', id: number, kind: string, index: number }

type LabelModalAction =
  | { type: 'OPEN_NEW_LABEL_MODAL', clientX: number, clientY: number, kind: string }
...
export type LabelAction =
  ...
  | { type: 'DRAG_END_LABEL' }
  | { type: 'DROP_LABEL', id: number, kind: string, index: number }
